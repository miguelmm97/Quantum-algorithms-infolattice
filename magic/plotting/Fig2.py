...
ax00.text(-80 * 3, 330 * 3, '$n$: $0$', fontsize=fontsize)
ax00.text(200 * 3, 330 * 3, '$1$', fontsize=fontsize)
ax00.text(360 * 3, 330 * 3, '$2$', fontsize=fontsize)
ax00.text(530 * 3, 330 * 3, '$3$', fontsize=fontsize)
ax00.text(690 * 3, 330 * 3, '$4$', fontsize=fontsize)
ax00.text(850 * 3, 330 * 3, '$5$', fontsize=fontsize)
ax00.text(970 * 3, 120 * 3, 'Folding', fontsize=fontsize-5)
# ax00.text(1100, 400, '$n_{\\rm folded}$: $0$', fontsize=fontsize)
ax00.text(1170 * 3, 410 * 3, '$n\'$:', fontsize=fontsize)
ax00.text(1310 * 3, 410 * 3, '$0$', fontsize=fontsize)
ax00.text(1490 * 3, 410 * 3, '$1$', fontsize=fontsize)
ax00.text(1655 * 3, 410 * 3, '$2$', fontsize=fontsize)
ax00.text(1170 * 3, -20 * 3, '$n$:', fontsize=fontsize)
ax00.text(1275 * 3, -20 * 3, '$0  {\\scriptstyle \\cup}$'+'$5$', fontsize=fontsize)
ax00.text(1450 * 3, -20 * 3, '$1  {\\scriptstyle \\cup}$'+'$4$', fontsize=fontsize)
ax00.text(1620 * 3, -20 * 3, '$2  {\\scriptstyle \\cup}$'+'$3$', fontsize=fontsize)
